...
<style src="SurveyBuilder.css" type="text/css" rel="stylesheet"></style>
...
<br>
<br>
<button id="Continue-btn" onclick="Open()" disabled="true" title="Next">Next</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="Close()" disabled="true" title="Cancel" id="Cancel-btn">Cancel</button>
...
var Page = document.getElementById("Connect").value;
if(x == true){window.open(Page, "_self");}else{
return false;
}
}
//Close
function Close(){
var x = confirm('Are your sure you want to leave?');
if(x == true){
window.close();
}
else{
...
//Change Text
function NextLabel(){
document.getElementById("Continue-btn").innerText = document.getElementById("Next-btn-label").value;
}
//Change Text
function CancelLabel(){
document.getElementById("Cancel-btn").innerText = document.getElementById("Cancel-btn-label").value;
}
//Find SurveyMaker editor file
function Find(){
var x = document.getElementById("Connect");
if(x.value == "SurveyBuilder[Page 2].html"){
alert("Sorry you can't use this file");
x.value = "";
}else{
return false;
}
...
<br>
<br>
<strong>Next button label:</strong>&nbsp;<input type="text" onchange="NextLabel()" id="Next-btn-label" placeholder="Next button label"/>
<br>
<br>
<strong>Cancel button label:</strong>&nbsp;<input type="text" onchange="CancelLabel()" id="Cancel-btn-label" placeholder="Cancel button label"/>
<br>
<br>
<strong>Connect Finished File(Ex. SurveyBuilder[Page 2].html):</strong><input type="text" oninput="Find()" id="Connect" placeholder="Connect file"/>
<br>
<br>

<br>
<br>
<button onclick="javascript:document.getElementById('Continue-btn').disabled = false;document.getElementById('Cancel-btn').disabled = false;document.getElementById('Editor').hidden = true;document.getElementById('Editing-container').hidden = true; richTextField.document.designMode = 'Off'; ">Publish</button>
</div>
</center>
</body>
</html>